...
export default function ProductCard({ product, onLike, onPass }) {
    ...
    return (
        <View style={styles.card}>
            ...
            <Text style={styles.name}>{product.name || 'Produit'}</Text>
            ...
            <View style={styles.impact}>
                <View style={styles.impactItem}>
                    ...
                    />
                    <Text style={styles.impactText}>{product.plasticSaved || 0}g</Text>
                </View>
                <View style={styles.impactItem}>
                    <AppIcon
                        name="leaf"
                        ...
                        style={styles.impactIcon}
                    />
                    <Text style={styles.impactText}>{product.co2Saved || 0}kg</Text>
                </View>
            </View>
